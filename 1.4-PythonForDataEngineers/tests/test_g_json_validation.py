# The __init__.py file in the test folder is required to make Python treat 
# directories containing the files as packages. Without this src.jsonValidation would not work.
...
# You make a Class then a bunch of functions.
class Test_JSONValidation:

    def test_validate_json_Should_return_True_when_valid_json_string(self):
        # Arrange: Prepare the data that you're going to put into the function as a test.
        ...
        # Act: Test the function. Save the output.
